...
Social Auth Uber Module is a Uber Authentication integration for Drupal.
 ...
 * Download Uber Base Library for TheLeague OAuth2 PHP library
   (https://github.com/thephpleague/oauth2-uber). We recommend to use
...
User can click on the Uber logo on the Social Auth Login block
...
user to Uber Accounts for authentication. Uber then returns the user to
